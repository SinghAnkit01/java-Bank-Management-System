...
public class cbemail extends JFrame {
    String pinnumber,card,email,number,bank,branch,name2;
    static int balance;
    cbemail(String card,String pinnumber,String email,String number,String bank,String branch, String name2, int balance){
        ...
        String subject = " BALANCE ENQUIRY MESSAGE FROM UK BANK OF INDIA";
        String to = email;
