...
public class pcemail extends JFrame {
    String formno,name2,pinnumber,cardnumber,email,text1;
    pcemail(String formno,String name2,String cardnumber,String pinnumber,String email,String text1){
        ...
        String subject = " PIN-CHANGE DETAILS FROM UK BANK OF INDIA";
        String to = email;
    ...
    m.setText( "Cardnumber starting from :" + message1 +  " " + " pin has been change successfully" + "\n"+ "New-Pin:" + text1  + "\n" + "For more details E-Mail here :" + email + " \n" + "Login to view Passbook page"  );
    setVisible(false);
    // new pinchange(text1, "").setVisible(true);
    // new BankManagementSystemApplication();
    new Transaction(formno, name2, "", "", "");
